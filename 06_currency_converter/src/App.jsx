...
function App() {
  ...
  return (
    <div className="w-full h-screen flex flex-wrap justify-center items-center bg-gradient-to-br from-blue-900 via-slate-900 to-black">
      <div className="w-full">
        <div className="w-full max-w-md mx-auto border border-gray-500 rounded-2xl p-6 backdrop-blur-sm bg-white/10">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              convert();
